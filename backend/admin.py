...
from .config_writer import (
    atomic_write_yaml,
    load_yaml,
    patch_auth as _patch_auth,
    patch_concurrency as _patch_concurrency,
    patch_router as _patch_router,
    patch_tiers as _patch_tiers,
    patch_vram as _patch_vram,
)
...
# Config PATCH — whitelisted YAML field updates with atomic write +
# in-memory hot-reload. The mutation helpers live in `config_writer.py`;
# this endpoint dispatches each top-level body section to the right one.
